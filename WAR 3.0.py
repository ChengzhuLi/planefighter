...
def main():
    ...
    # TODO load为装载路径，本地址直接用.表示
    # allimage = pygame.image.load("images/hero/shoot.png")   # 加载共享大图
    # player = allimage.subsurface(0,99,102,106)    # 共享大图中加载玩家飞机
    playerpos = (background.get_rect().w/2 - player.get_rect().w/2, 600)
    # 居中公式
    # 前者是横坐标，后者是纵坐标，分别对应为0和1
    # print("777"+playerpos)
    # 3 游戏主循环
